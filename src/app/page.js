...
export default function Home() {
  const imagemQuemSomos = '/quemSomos.jpg'
        ...
        <main className="flex flex-col gap-12 w-full max-w-6xl">
          ...
          <section className="flex flex-col gap-8 mt-8">
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-center">
              ...
              />
              <h3 className="text-gray-800 text-lg max-w-xl italic font-[family-name:var(--font-geist-sans)]">
                O Semeia é mais do que um projeto, é um movimento que nasce do encontro entre sustentabilidade, inovação e propósito social! 
                Nossa essência está em semear ideias que florescem em impacto real, conectando pessoas, marcas e comunidades em torno de soluções conscientes.
                <br /><br />
                Somos jovens inquietos que acreditam que cada escolha pode transformar o futuro. 
                O Semeia é a junção de visões diversas, unidas por um mesmo sonho: criar caminhos sustentáveis que gerem valor para a sociedade e para o planeta.
              </h3>
            </div>
          </section>
...
E claro, não fazemos tudo isso sozinhos, nós contamos com parcerias incríveis de ONGs locais, que colocam a mão na massa e garantem que tudo seja entregue direitinho. <strong> Nosso propósito é claro: combater a fome de forma eficiente, sustentável e transparente, contribuindo com o Objetivo de Desenvolvimento Sustentável 2.1 da ONU com o objetivo de acabar com a fome até 2030.</strong>
</p>
    </div>
